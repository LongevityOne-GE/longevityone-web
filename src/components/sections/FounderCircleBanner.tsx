...
const content = {
  ka: {
    ...
    body: 'Founder Circle 50 შექმნილია იმ ადამიანებისთვის, რომლებიც ჯანმრთელობასა და აქტიურ დღეგრძელობას საკუთარ მომავალში ინვესტიციად თვლიან.',
    benefits: [
      ...
      'IHHT (ინტერვალური ჰიპოქსიურ-ჰიპეროქსიული თერაპია) - ულიმიტოდ',
