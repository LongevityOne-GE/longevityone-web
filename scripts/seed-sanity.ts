...
const technologyDocs = [
  ...
  },
  {
    ...
    _id: 'tech-visbody',
    name: 'Visbody 3D',
    slug: { _type: 'slug', current: 'visbody' },
    order: 2,
    tagline_ka: 'თქვენი სხეული სამ განზომილებაში',
    tagline_en: 'Your body in three dimensions',
    whatItIs_ka: 'Visbody არის უახლესი 3D სხეულის სკანირების სისტემა, რომელიც ერთ სკანირებაში გვაძლევს თქვენი სხეულის კომპოზიციის სრულ სურათს. პროცედურა სწრაფი, უმტკივნეულო და გამოსხივების გარეშეა — სკანირება მხოლოდ რამდენიმე წამს სჭირდება.',
    whatItIs_en: 'Visbody is a state-of-the-art 3D body scanning system that provides a complete picture of your body composition in a single scan. The procedure is fast, painless, and radiation-free — taking only a few seconds.',
    whatItShows_ka: 'სხეულის ცხიმის პროცენტი, კუნთოვანი მასა, ვისცერალური ცხიმი, ჩონჩხის სიმეტრია და კუნთების ბალანსი სხეულის სხვადასხვა ნაწილში.',
    whatItShows_en: 'Body fat percentage, muscle mass, visceral fat, skeletal symmetry, and muscle balance across different body segments.',
    yourBenefit_ka: 'ობიექტური, ციფრული „ბაზური სურათი" თქვენი სხეულის — ვარაუდებისა და სუბიექტური შეფასებების გარეშე. ეს გაზომვა გამოიყენება პროგრესის თვალყურისდევნებისთვის ყოველ ვიზიტზე.',
    yourBenefit_en: 'An objective, digital baseline of your body — free from assumption or subjective assessment. This measurement becomes your progress benchmark at every visit.',
  },
  {
    _type: 'technology',
    _id: 'tech-ihht',
...
const faqItemDocs = [
  ...
  },
  {
    ...
    answer_ka: textToPortableText('პირველი ვიზიტი მოიცავს სრულ ბიოლოგიურ აუდიტს: PNOE მეტაბოლური ტესტირება, Visbody 3D სხეულის სკანირება და დეტალური კონსულტაცია ჩვენს ექიმთან. ვიზიტი გრძელდება დაახლოებით 2-3 საათს.'),
    answer_en: textToPortableText('The first visit includes a complete biological audit: PNOE metabolic testing, Visbody 3D body scanning, and a detailed consultation with our physician. The visit lasts approximately 2-3 hours.'),
    category: 'services',
    order: 3,
  },
  {
...
const journeyStageDocs = [
  ...
  },
  {
    ...
    body_ka: textToPortableText('კლინიკაში ჩატარდება სრული ბიოლოგიური შეფასება: PNOE მეტაბოლური ტესტი, Visbody 3D სკანირება, ეპიგენეტიკური ანალიზი და მიკრობიომის კვლევა.'),
    body_en: textToPortableText('At the clinic, a complete biological assessment is conducted: PNOE metabolic test, Visbody 3D scan, epigenetic analysis, and microbiome research.'),
  },
  {
    _type: 'journeyStage',
    _id: 'journey-stage-3',
  ...
  },
  {
    ...
    body_ka: textToPortableText('რეგულარული შეფასებები და გაზომვები — Visbody სკანირება ყოველ ვიზიტზე პროგრესის თვალყურისდევნებისთვის.'),
    body_en: textToPortableText('Regular assessments and measurements — Visbody scanning at every visit to track progress.'),
  },
  {
    _type: 'journeyStage',
    _id: 'journey-stage-7',
