...
const members: MemberDraft[] = [
  {
    ...
    credentials: ['MD', 'MBA'],
    boardRole: 'chair',
    title_ka: 'კლინიკური და სამეცნიერო მრჩეველი, საკონსულტაციო საბჭოს თავმჯდომარე',
    title_en: 'Clinical & Scientific Advisor, Chair of the Scientific Advisory Board',
